...
class Simulation:
    def __init__(self, Model, Memory, TrafficGen, sumo_cmd, gamma, max_steps, green_duration_veh, green_duration_ped,
    ...
    def run(self, episode, epsilon):
        ...
        while self._step < self._max_steps:
            ...
            # print("current_total_wait",current_total_wait)
    ...
    def _collect_ped_waiting_times(self):
        ...
        # print("total_ped",len(ped_list))
        # print("total_ped_waiting_time",total_ped_waiting_time)
    ...
    def _choose_action(self, state, epsilon):
        ...
        if random.random() < epsilon:
            val = random.randint(0, self._num_actions - 1)
            # print(val)
            return val  # random action
        else:
            max_state = np.argmax(self._Model.predict_one(state))
            return max_state
            # return  # the best action given the current state
